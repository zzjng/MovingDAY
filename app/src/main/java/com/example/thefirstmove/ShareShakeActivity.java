...
public class ShareShakeActivity extends AppCompatActivity {
    // 两次检测的时间间隔
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.share_shake);
        linearLayout = (LinearLayout) findViewById(R.id.share_shake);
        linearLayout.setBackgroundResource(R.mipmap.img1);
        Toast.makeText(ShareShakeActivity.this,"摇晃手机以切换图片",Toast.LENGTH_LONG).show();
    }
    /**
     * 获取焦点注册监听器
     */
