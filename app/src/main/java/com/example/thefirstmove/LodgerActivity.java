...
import com.example.thefirstmove.hezu.SearchView;

import java.util.ArrayList;
import java.util.List;

public class LodgerActivity extends Activity implements SearchView.SearchViewListener{
    ...
    public static void setHintSize(int hintSize) {
        LodgerActivity.hintSize = hintSize;
    }
    ...
    private void initViews() {
        ...
        lvResults.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Toast.makeText(LodgerActivity.this, position + "", Toast.LENGTH_SHORT).show();
            }
        });
    }
